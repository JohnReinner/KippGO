...
import { Activity, Bell, CalendarDays, ChevronDown, CircleCheck, Dumbbell, Flame, HeartPulse, LayoutDashboard, LogOut, Menu, MessageCircle, MoreHorizontal, Search, Settings, Sparkles, Target, TrendingUp, Users, X, type LucideIcon } from "lucide-react";
...
const metrics: Array<[LucideIcon,string,string,string,string]>=[
 [Users,"ALUNOS ATIVOS","48","6,7%","violet"],
 [Dumbbell,"TREINOS CONCLUÍDOS","326","12,4%","coral"],
 [Target,"METAS ALCANÇADAS","21","de 34 ativas","cyan"],
 [Flame,"RETENÇÃO","94%","2,1%","amber"],
];
 ...
 return <main className="shell">
  ...
  <section className="content">
   ...
   <div className="dash">
    ...
    <section className="metrics">{metrics.map(([Icon,label,value,note,color])=><article key={label}><i className={color}><Icon/></i><div><span>{label}</span><h3>{value}</h3><p><TrendingUp/>{note}</p></div></article>)}</section>
